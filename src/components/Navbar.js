...
function Navbar(){
    ...
    return(
        <div>
            <nav className="bg-lime-600 border-gray-200 mb-2">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4 mr-4">
                    ...
                    <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul class="font-medium flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-600 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-600 border-gray-200">
                            <NavLink to='/'>
                            ...
                            <Dropdown label="Categories" dismissOnClick={false} className="z-50" inline>
                            ...
                            <Dropdown label="User" dismissOnClick={false} className="z-50" inline>
                            <Dropdown.Header>
